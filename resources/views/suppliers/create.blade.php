...
@section('page-header')
    <div>
        <h1 class="text-4xl font-bold text-gray-900 mb-2">Add New Supplier</h1>
        <p class="text-gray-600">Create a new supplier entry in your database</p>
    </div>
@endsection
...
@section('content')
    <div class="max-w-2xl mx-auto">
        ...
        <div class="mt-6 bg-blue-50 border border-blue-200 rounded-lg p-4 text-sm text-blue-800">
            <p class="font-semibold mb-2">ℹ️ Required Fields</p>
            <p>All fields marked with an asterisk (*) are required to create a new supplier.</p>
        </div>
    </div>
@endsection
